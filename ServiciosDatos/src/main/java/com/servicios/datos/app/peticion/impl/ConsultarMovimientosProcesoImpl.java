...
public class ConsultarMovimientosProcesoImpl implements ConsultarMovimientosProceso {
	...
	public ConsultarMovimientosProcesoRespuesta ejecutar(ConsultarMovimientosProcesoPeticion peticion)
		...
		respuesta.setListaMovimientosProceso(peticionMapper.consultarMovimientosProceso(peticion));
